...
export const defaultLandmarks: Landmark[] = [
    ...
    transitions: [
      {
        ...
        conditions: [{ type: 'quality_check', key: 'tension', op: '>=', value: 1 }]label: '气氛出现裂痕',
      },
      {
        target_id: 'lm_2_cracks',
        conditions: [], label: '回合兜底',
      },
    ],
    ...
    transitions: [
      {
        ...
        conditions: [{ type: 'flag_check', key: 'trip_confessed', op: '==', value: true }]label: 'Trip 承认秘密',
      },
      {
        target_id: 'lm_3b_grace',
        conditions: [{ type: 'flag_check', key: 'grace_exposed', op: '==', value: true }]label: 'Grace 揭露过去',
      },
      {
        target_id: 'lm_3b_grace',
        conditions: [], label: '回合兜底',
    ...
    transitions: [
      {
        ...
        conditions: [{ type: 'quality_check', key: 'tension', op: '>=', value: 3 }]label: '进入摊牌',
      },
      {
        target_id: 'lm_4_resolve',
        conditions: [], label: '回合兜底',
    ...
    transitions: [
      {
        ...
        conditions: [{ type: 'flag_check', key: 'honest_conversation', op: '==', value: true }]label: '坦诚面对',
      },
      {
  ...
  },
  {
    ...
    transitions: [],
    narrative_constraints: {},    fallback_storylet: undefined,
...
export const defaultStorylets: Storylet[] = [
  // ─── act1: 做客 ───
  {
    ...
    conditions: [{ type: 'flag_check', key: 'arrived', op: '==', value: false }],    content: {
